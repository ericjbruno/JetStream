...
public class JetStreamTemporaryQueue extends JetStreamQueue implements TemporaryQueue {

    protected JetStreamTemporaryQueue() {
    }

    public JetStreamTemporaryQueue(String queueName) throws Exception {
        super(queueName);
    }
