...
public class JetStreamTopicConnectionFactory extends JetStreamConnectionFactory implements TopicConnectionFactory {

    public JetStreamTopicConnectionFactory() {
    }

    public TopicConnection createTopicConnection()
            throws JMSException {
        return new JetStreamTopicConnection();
    }

    public TopicConnection createTopicConnection(String usr, String pwd)
            throws JMSException {
        return new JetStreamTopicConnection();
    }
}
